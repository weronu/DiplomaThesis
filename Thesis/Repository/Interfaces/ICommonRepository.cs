...
namespace Repository.MSSQL.Interfaces
{
    public interface ICommonRepository
    {
        ...
        TEntity GetByIdNoTracking<TEntity>(int id) where TEntity : DomainBase;
        TEntity GetByIdNoTracking<TEntity>(int id, params Expression<Func<TEntity, object>>[] includes) where TEntity : DomainBase;
