...
\begin{figure}[H]
\centering
\includegraphics[width=5cm, height=3.5cm]{figures/team_ssrm}
...
\paragraph{Brokerage}
V na obr. \ref{team_brokerage} je zobrazených desať najväčších \textit{broker} aktérov v sieti spolu s grafom ich čiatkovým skóre pre každú \textit{brokerage} rolu, ako aj celkové \textit{brokerage} skóre.


\begin{figure}[H]
\centering
\includegraphics[width=15cm, height=7cm]{figures/team_brokerage_tab}
\caption{Rozloženie komunít za tretí časový úsek}
\label{team_brokerage}
\end{figure}
