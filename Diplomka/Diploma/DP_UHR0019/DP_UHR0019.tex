...
Do aplikácie je možné nahrať XML súbor, ktorý je spracovaný uloženou SQL procedúrou, ktorá rozparsuje emailové dáta na jednodlivé entity - \textit{User, EmailMessage} a \textit{Conversation} a uloží ich do SQL databázy.

!!!doplnit datovy model!!!
...
and Teams in Organizations}
	...
	\bibitem{13} Do Millennial and Gen Z Consumers Still Use Email? \textit{https://www.bluecore.com/blog/do-millennials-use-email/}
