...
\begin{figure}[H]
\centering
\includegraphics[width=14cm, height=5cm]{figures/team_tab_celkovo}
...
\paragraph{Zmeny siete v závislosti nad voľbou ega}
...
\subsection{Porovnanie jednotlivých členov týmu}
